module.exports = function(app, passport) {
    ...
    app.get('/login_admin', function(req, res){
        res.render('login_admin.html',{message: req.flash('loginMessage')});
    });

    app.post('/login_admin', passport.authenticate('admin-login', {
        successRedirect : '/profile_admin', // redirect to the secure profile section
    ...
    app.get('/profile_admin', isLoggedIn, function(req, res) {
        res.render('profile_admin.html', {
            user : req.user // get the user out of session and pass to template
        });
    });
    ...
    app.get('/editar_usuario', function (req, res) {
        res.render('editar_usuario.html');
    });
}
